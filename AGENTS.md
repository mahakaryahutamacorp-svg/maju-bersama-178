...
The login page (`/login`): **customers** sign in with **no. HP** (e.g. `0812…`, normalized to `62…` for a synthetic `@local.mb178` email); **owners** use **username** (e.g. `mama01`). The app never asks for a real email. Test owner accounts use password `223344`; super-admin accounts use `178178`. See `supabase/README.md` for the full list.
