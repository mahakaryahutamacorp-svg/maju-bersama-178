...
('toko03', 'B/T3mtyzB813J0U7Rs0iNykU9b+CQtFJOCkMc8qbics=', 'i87KA/LT4zmLxkh4KAw6zA==', 'Owner Elektronik','owner', (select id from mb178.stores where slug='toko-elektronik')),
('toko04', 'ae0/C6U1P2g+aMrSPMMRclzJjR0DvPM6cjC7DhlDEBM=', 'g5ji06p9XBRSCUGZKkmJSA==', 'Owner Fashion',   'owner', (select id from mb178.stores where slug='fashion-murah')),
('toko05', 'xabjBQaueXT7ENbtO0ll+vdygxmyNGLDkSvIj+2PXDw=', 'wNkBkQ17kUtH9H8RyBwCxg==', 'Owner Bangunan',  'owner', (select id from mb178.stores where slug='toko-bangunan')),
('toko06', 'jIYP/J2oZO6OUi4ajf1rLBE3Bm+N3eO3rFrNeX/W3RQ=', 'rK+VbwfVSHTKockwKm0Zww==', 'Owner Sembako',   'owner', (select id from mb178.stores where slug='sembako-berkah')),
('toko07', 'b4WkxYZ1Ej75IX6zBKyssC1wr/oVujH6pAhMd0bAvdo=', 'mIShmaBhREUEn+wjUbCcFA==', 'Owner ATK',       'owner', (select id from mb178.stores where slug='toko-alat-tulis')),
('toko08', 'Mw3CyWw4siI6eXwdNgfb75QZrfCko91p8eClo/bUFso=', 'DCmfiku/eVEDZ497qGE2ag==', 'Owner Kosmetik',  'owner', (select id from mb178.stores where slug='toko-kosmetik'));
